...
abstract class AppLocalizations {
  ...
  /// No description provided for @tabMyWall.
  ///
  /// In en, this message translates to:
  /// **'My Wall'**
  String get tabMyWall;

  /// No description provided for @tabGive.
  ///
  /// In en, this message translates to:
  /// **'Give'**
  String get tabGive;
  ...
  /// No description provided for @layABrick.
  ///
  /// In en, this message translates to:
  /// **'Lay a brick'**
  String get layABrick;

  /// No description provided for @layThisBrick.
  ///
  /// In en, this message translates to:
  /// **'Lay this brick'**
  String get layThisBrick;
  ...
  /// No description provided for @yourWall.
  ///
  /// In en, this message translates to:
  /// **'Your wall'**
  String get yourWall;

  /// No description provided for @feedbackFriday.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @growthNotesPrivate.
  ///
  /// In en, this message translates to:
  /// **'Growth notes stay private to them — they never appear on a public wall.'**
  String get growthNotesPrivate;

  /// No description provided for @claimYourWall.
  ///
  /// In en, this message translates to:
  /// **'Claim your own wall'**
  String get claimYourWall;
}
